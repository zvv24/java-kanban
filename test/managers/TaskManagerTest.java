...
public abstract class TaskManagerTest<T extends TaskManager> {
    ...
    void canDeleteAllTasks() {
        ...
        assertNull(manager.searchSubtaskByID(4));
    }
    ...
    @Test
    void prioritiesSetCorrectly() {
        Task task1 = new Task(5, "Ранняя задача", "Описание", Status.NEW,
                LocalDateTime.now().minusHours(1), Duration.ofMinutes(30));
        manager.newTask(task1);

        assertEquals(task1, manager.getPrioritizedTasks().first());
    }
